...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"unitedpeoplescoinaddress\"\n"
            "\nReveals the private key corresponding to 'unitedpeoplescoinaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"unitedpeoplescoinaddress\"   (string, required) The unitedpeoplescoin address for the private key\n"
            "\nResult:\n"
