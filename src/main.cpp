...
#if defined(NDEBUG)
# error "UnitedPeoplesCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "UnitedPeoplesCoin Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // UnitedPeoplesCoin also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // UnitedPeoplesCoin also requires low S in sigs
