...
const QString BITCOIN_IPC_PREFIX("unitedpeoplescoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/unitedpeoplescoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/unitedpeoplescoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/unitedpeoplescoin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click unitedpeoplescoin: links
...
//
// OSX-specific way of handling unitedpeoplescoin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in unitedpeoplescoin: URIs
...
void PaymentServer::handleURIOrFile(const QString &s)
{
    ...
    // unitedpeoplescoin: CashAddr URI
