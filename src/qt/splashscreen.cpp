    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextUnitedPeoplesCoin   = QChar(0xA9)+QString(" %1 ").arg(2022) + QString("The UnitedPeoplesCoin developers");
    ...
    // draw copyright stuff
    {
        ...
        pixPaint.drawText(x,y+30,copyrightTextUnitedPeoplesCoin);
    }
